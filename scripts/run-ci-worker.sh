...
receipt_libs="$(receipt_value libs_sha)" || refuse "invalid worker provenance receipt private-libs field"
...
is_oid "$receipt_libs" || refuse "receipt contains an invalid private provenance gitlink SHA"
